...
import MemberForm from "../excos/components/create/CreateForm";
import ExcosTable from "../excos/components/ExcosTable";
...
export default async function Dashboard() {
  ...
  const isModerator = userSession.session?.user?.user_metadata.role === "moderator";
                    ...
                    >
                      <CardHeader className="flex flex-row items-center">
                        <div className="grid gap-2">
                          <CardTitle>Create Executives</CardTitle>
                          <CardDescription>
                            Executives Form
                          </CardDescription>
                        </div>
                      ...
                      <CardContent>
                          <MemberForm isAdmin={isAdmin} permissions={permissions}/>
                      </CardContent>
